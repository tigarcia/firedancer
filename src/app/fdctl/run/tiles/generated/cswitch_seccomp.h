...
#ifndef HEADER_fd_src_app_fdctl_run_tiles_generated_cswitch_seccomp_h
#define HEADER_fd_src_app_fdctl_run_tiles_generated_cswitch_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_cswitch_instr_cnt = 20;

static void populate_sock_filter_policy_cswitch( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd) {
  FD_TEST( out_cnt >= 20 );
  struct sock_filter filter[20] = {
    ...
    /* simply allow read */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_read, /* RET_ALLOW */ 12, 0 ),
